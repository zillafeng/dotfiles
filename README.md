...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/zillafeng/dotfiles/master/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/zillafeng/dotfiles/master/install.sh`" -s ask
```
